...
import de.hsrt.db2.TeleConsultCore.command.chat.CreateChat;
import de.hsrt.db2.TeleConsultCore.command.message.MarkRead;
import de.hsrt.db2.TeleConsultCore.command.message.SendMsg;
import de.hsrt.db2.TeleConsultCore.command.user.CreateUser;
...
import de.hsrt.db2.TeleConsultCore.service.TeleConsultService;
...
class TeleConsultDBApplicationTests {
	private final TeleConsultService consultService;
